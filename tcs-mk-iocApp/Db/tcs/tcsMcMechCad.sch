...
[tools]
[detail]
w 610 800 100 0 n#65 ecad8.ecad8#23.STLK 288 480 608 480 608 1072 992 1072 estringouts.null.SLNK
...
w 1064 434 100 0 n#49 elongouts.mark.FLNK 1248 592 1312 592 1312 432 864 432 864 304 992 304 elongouts.start.SLNK
...
s -656 1824 100 0 commands
s -656 1856 100 0 This ensures unique names for the azel, azimuth and elevation
s -656 1888 100 0 to be defined at a higher level.
s -656 1920 100 0 and tcsMechanismCad is that this one allows index
s -656 1952 100 0 N.B. The only difference between this schematic
...
s 1808 2000 100 0 $Id: tcsMcMechCad.sch,v 1.2 2002/02/18 14:49:28 cjm Exp $
...
p 1104 992 100 1024 0 name:$(tcs)$(cad)$(I)
...
p 1216 464 100 1024 1 name:$(tcs)$(cad)$(I)
p 1248 528 75 768 -1 pproc(OUT):CA
...
p 1248 272 75 768 -1 pproc(OUT):CA
...
p 288 1120 75 768 -1 pproc(OUTA):CA
...
p 288 736 75 768 -1 pproc(OUTG):CA
p 288 672 75 768 -1 pproc(OUTH):CA

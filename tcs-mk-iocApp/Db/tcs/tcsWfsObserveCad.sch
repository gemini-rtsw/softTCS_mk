...
[tools]
[detail]
w 776 1467 100 0 n#77 ecad20.ecad20#66.STLK 336 112 608 112 608 1456 992 1456 estringouts.expTime.SLNK
w 1080 907 100 0 n#76 elongouts.m2Busy.FLNK 1248 1056 1344 1056 1344 896 864 896 864 784 992 784 estringouts.null.SLNK
w 1080 1147 100 0 n#75 estringouts.wfs.FLNK 1248 1248 1344 1248 1344 1136 864 1136 864 1024 992 1024 elongouts.m2Busy.SLNK
w 1080 1355 100 0 n#74 estringouts.expTime.FLNK 1248 1472 1344 1472 1344 1344 864 1344 864 1232 992 1232 estringouts.wfs.SLNK
w 920 1058 100 0 n#71 hwin.hwin#73.in 896 1056 992 1056 elongouts.m2Busy.DOL
w 640 1499 100 0 n#69 ecad20.ecad20#66.VALB 336 1488 992 1488 estringouts.expTime.DOL
w 1064 674 100 0 n#64 estringouts.null.FLNK 1248 800 1312 800 1312 672 864 672 864 544 992 544 elongouts.busy.SLNK
w 1496 50 100 0 n#63 elongouts.start.FLNK 1248 48 1792 48 1792 256 1888 256 tcsSubCadWait.tcsSubCadWait#55.START
w 1064 418 100 0 n#61 elongouts.busy.FLNK 1248 576 1312 576 1312 416 864 416 864 272 992 272 elongouts.mark.SLNK
w 920 578 100 0 n#59 hwin.hwin#58.in 896 576 992 576 elongouts.busy.DOL
w 920 50 100 0 n#54 hwin.hwin#52.in 896 48 992 48 elongouts.start.DOL
w 920 306 100 0 n#53 hwin.hwin#51.in 896 304 992 304 elongouts.mark.DOL
w 1064 146 100 0 n#49 elongouts.mark.FLNK 1248 304 1312 304 1312 144 864 144 864 16 992 16 elongouts.start.SLNK
...
[cell use]
use hwin 728 1016 100 0 hwin#73
xform 0 800 1056
p 707 1048 100 0 -1 val(in):$(CAD_START)
...
use elongouts 1016 936 100 0 m2Busy
xform 0 1120 1024
p 1040 1118 100 0 -1 DESC:Start Directive
p 832 942 100 0 0 OMSL:closed_loop
p 1328 990 100 0 -1 def(OUT):$(m2)exposuretime.DIR
p 1232 928 100 1024 0 name:$(tcs)$(cad)$(I)
p 1248 992 75 768 -1 pproc(OUT):CA
...
use estringouts 992 1159 100 0 wfs
xform 0 1120 1232
p 1056 1296 100 0 -1 DESC:WFS name
p 928 1038 100 0 0 OMSL:supervisory
p 928 1198 100 0 0 VAL:$(text)
p 1360 1216 100 0 -1 def(OUT):$(m2)exposuretime.B
p 1104 1152 100 1024 0 name:$(tcs)$(cad)$(I)
p 1248 1216 75 768 -1 pproc(OUT):CA
use estringouts 992 1383 100 0 expTime
xform 0 1120 1456
p 1040 1536 100 0 -1 DESC:Exposure time
p 928 1262 100 0 0 OMSL:closed_loop
p 928 1422 100 0 0 VAL:0.0
p 1360 1440 100 0 -1 def(OUT):$(m2)exposuretime.A
p 1104 1376 100 1024 0 name:$(tcs)$(cad)$(I)
p 1248 1440 75 768 -1 pproc(OUT):CA

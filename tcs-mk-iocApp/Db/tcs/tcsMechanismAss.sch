...
w 1064 171 100 0 n#79 elongouts.mode.FLNK 1248 320 1312 320 1312 160 864 160 864 32 992 32 elongouts.start.SLNK
w 1064 427 100 0 n#78 elongouts.busy.FLNK 1248 576 1312 576 1312 416 864 416 864 288 992 288 elongouts.mode.SLNK
w 920 322 100 0 n#75 hwin.hwin#77.in 896 320 992 320 elongouts.mode.DOL
...
s 1808 2000 100 0 $Id: tcsMechanismAss.sch,v 1.1 2002/10/02 08:28:03 cjm Exp $
...
use hwin 728 280 100 0 hwin#77
xform 0 800 320
p 707 312 100 0 -1 val(in):1
...
use elongouts 1016 200 100 0 mode
xform 0 1120 288
p 1040 382 100 0 -1 DESC:Set mode
p 832 206 100 0 0 OMSL:closed_loop
p 1328 254 100 0 -1 def(OUT):$(subsys)$(subcad).MODE
p 1232 192 100 1024 1 name:$(tcs)$(cad)$(I)
p 1248 256 75 768 -1 pproc(OUT):CA

...
p 1680 -802 100 0 -1 def(OUT):$(oi)probePark.DIR
p 1456 -864 100 1024 -1 name:$(ag)oiwfssPark
...
p 1680 -546 100 0 -1 def(OUT):$(oi)probePark.DIR
p 1456 -608 100 1024 -1 name:$(ag)oiwfsmPark
...
p 1680 318 100 0 -1 def(OUT):$(p1)probePark.DIR
p 1456 256 100 1024 -1 name:$(ag)pwfs1sPark
...
p 1680 574 100 0 -1 def(OUT):$(p1)probePark.DIR
p 1456 512 100 1024 -1 name:$(ag)pwfs1mPark
...
p 1680 -242 100 0 -1 def(OUT):$(p2)probePark.DIR
p 1456 -304 100 1024 -1 name:$(ag)pwfs2sPark
...
p 1680 14 100 0 -1 def(OUT):$(p2)probePark.DIR
p 1456 -48 100 1024 -1 name:$(ag)pwfs2mPark

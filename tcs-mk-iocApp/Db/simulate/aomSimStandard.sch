...
[tools]
[detail]
w -1038 299 100 0 n#105 esels.InPosSelect.FLNK -1056 288 -960 288 -960 96 -864 96 esirs.inPosition.SLNK
w -990 267 100 0 n#104 esels.InPosSelect.VAL -1056 256 -864 256 esirs.inPosition.INP
w -1566 171 100 0 n#103 ebos.InPosFake.VAL -1600 160 -1472 160 -1472 400 -1344 400 esels.InPosSelect.INPB
w -1662 331 100 0 INPOS inhier.INPOS.P -1760 320 -1504 320 -1504 432 -1344 432 esels.InPosSelect.INPA
w -1494 475 100 0 n#101 ebos.InPosOverride.VAL -1584 464 -1344 464 esels.InPosSelect.NVL
w -1464 875 100 0 n#96 ecalcs.present.FLNK -1696 1056 -1536 1056 -1536 864 -1344 864 esirs.heartbeat.SLNK
w -1496 1035 100 0 n#51 junction -1600 1024 -1344 1024 esirs.heartbeat.INP
w -1872 1314 100 0 n#51 ecalcs.present.VAL -1696 1024 -1600 1024 -1600 1312 -2096 1312 -2096 1216 -1984 1216 ecalcs.present.INPA
s -176 -352 100 0 Sciences Ltd.
s -176 -320 100 0 Observatory
s -176 -288 100 0 Copyright
s -160 1904 100 0 $Id: aomSimStandard.sch,v 1.1 2007/12/18 09:50:53 cjm Exp $
[cell use]
...
p -1232 768 100 1024 0 name:$(top)$(subsys)$(I)
...
xform 0 -544 896
p -801 640 100 0 0 DESC:AOM health record in simulation
p -801 624 100 0 0 FDSC:AOM health (simulation)
p -616 808 100 0 1 FTVL:STRING
...
p -784 318 100 0 1 PV:$(top)$(subsys)

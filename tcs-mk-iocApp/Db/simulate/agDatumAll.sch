...
s 2096 1104 100 0 agDatumAll.sch
[cell use]
...
xform 0 328 -376
p 176 -512 100 0 1 seta:command datum
p 176 -544 100 0 1 setb:delay 0.5
...
p 1680 14 100 0 -1 def(OUT):$(p2)probeDatum.DIR
p 1456 -48 100 1024 -1 name:$(ag)pwfs2mDatum
...
p 1680 -242 100 0 -1 def(OUT):$(p2)probeDatum.DIR
p 1456 -304 100 1024 -1 name:$(ag)pwfs2sDatum
...
p 1680 574 100 0 -1 def(OUT):$(p1)probeDatum.DIR
p 1456 512 100 1024 -1 name:$(ag)pwfs1mDatum
...
p 1680 318 100 0 -1 def(OUT):$(p1)probeDatum.DIR
p 1456 256 100 1024 -1 name:$(ag)pwfs1sDatum
...
p 1680 -546 100 0 -1 def(OUT):$(oi)probeDatum.DIR
p 1456 -608 100 1024 -1 name:$(ag)oiwfsmDatum
...
p 1680 -802 100 0 -1 def(OUT):$(oi)probeDatum.DIR
p 1456 -864 100 1024 -1 name:$(ag)oiwfssDatum
